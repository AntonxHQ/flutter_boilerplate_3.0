...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<DateTimeService>(onMissingStub: OnMissingStub.returnDefault),
...
MockDateTimeService getAndRegisterDateTimeService() {
  _removeRegistrationIfExists<DateTimeService>();
  final service = MockDateTimeService();
  locator.registerSingleton<DateTimeService>(service);
  return service;
}
